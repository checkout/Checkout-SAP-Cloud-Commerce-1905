...
<div class="checkout-success">
    <div class="checkout-success__body">
        ...
        <p><spring:theme code="text.account.order.orderNumberLabel"/><strong> ${fn:escapeXml(orderData.code)}</strong>
        </p>
            ...
            <form:form method="post" modelAttribute="guestRegisterForm" class="checkout__new-account__form clearfix">
                <div class="col-sm-8 col-sm-push-2 col-md-6 col-md-push-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="${fn:escapeXml(guestRegisterForm.uid)}" class="form-control"
                               name="email" id="email" readonly>
                    </div>

                    <formElement:formPasswordBox idKey="password" labelKey="guest.pwd" path="pwd"
                                                 inputCSS="password strength form-control" mandatory="true"/>
                    <formElement:formPasswordBox idKey="guest.checkPwd" labelKey="guest.checkPwd" path="checkPwd"
                                                 inputCSS="password form-control" mandatory="true"/>
                    ...
                    <template:errorSpanField path="termsCheck">
                        <div class="checkbox">
                            <label class="control-label uncased">
                                ...
                                <spring:theme var="termsAndConditionsHtml" code="register.termsConditions"
