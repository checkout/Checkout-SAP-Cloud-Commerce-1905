...
public class CheckoutComChoosePaymentAndBillingCheckoutStepController extends CheckoutComAbstractPaymentAndBillingCheckoutStepController {
     ...
     */
    @Override
    @RequestMapping(method = GET, value = "/choose-payment-method")
    @RequireHardLogIn
     ...
     */
    @RequestMapping(value = "/choose-payment-method/choose", method = GET)
    @RequireHardLogIn
     ...
     */
    @RequestMapping(value = "/reload-payment-buttons", method = RequestMethod.GET)
    @RequireHardLogIn
